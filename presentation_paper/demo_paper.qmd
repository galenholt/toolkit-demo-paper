...
(\~/../Deakin University/QAEL - WERP in house - WERP/Toolkit/Writing/Demonstration paper/images/Conceptual_fig_demopaper2.png){#fig-graphab}
...
Here we describe the specific implementation of each component of the toolkit [@fig-tktomgmt], with additional detail in [@sec-appendix1].
...
plt_2 <- ggplot(filter(obj_sdl_to_plot, 
                       scenario %in% scenarios_to_plot2 & !is.na(Target)),
      aes(
...
*GEORGIA (priority ecosystem functions and environmental assets)*
